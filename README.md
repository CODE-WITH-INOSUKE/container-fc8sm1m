...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-fc8sm1m.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-fc8sm1m.containers.anotherwebservice.com/
...
```
git clone git@github.com:CODE-WITH-INOSUKE/container-fc8sm1m.git
cd container-fc8sm1m
```
...
```
docker attach container-fc8sm1m
```
